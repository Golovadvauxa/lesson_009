...
counter = StatCounter(file_name='voyna-i-mir.txt.zip', sort_method='Ascending')#'Ascending'-по возрастанию частоты;
counter.do_it()                                                                #'Descending'-по убыванию частоты;
                                                                               #'abcAscending'-по алфавиту;
                                                                               #'abcDescending'-по алфавиту с конца;
